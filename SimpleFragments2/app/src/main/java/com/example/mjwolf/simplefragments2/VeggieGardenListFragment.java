...
import com.example.mjwolf.simplefragments2.dummy.DummyContent;
import com.example.mjwolf.simplefragments2.dummy.DummyContent.DummyItem;
...
public class VeggieGardenListFragment extends ListFragment implements
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        //allow a only one item to be selected. There are other options.
        ...
        setListAdapter(new ArrayAdapter<>(getActivity(), android.R.layout.simple_list_item_activated_1, veggies));
